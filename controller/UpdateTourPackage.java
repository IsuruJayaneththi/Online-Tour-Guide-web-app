...
public class UpdateTourPackage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!filePart.getSubmittedFileName().isEmpty()) {
            ...
            pkgUpdateDao.updatePackageImageOne(id, tour_name, location_from, location_to, date, duration,price, desp1, desp2, imageUrl_1,hotel,transport);
            ...
            pkgUpdateDao.updatePackageImageTwo(id, tour_name, location_from, location_to, date,duration, price, desp1, desp2, imageUrl_2,hotel,transport);
            ...
            imageUrl_1 = filePart.getInputStream();
            imageUrl_2 = filePart2.getInputStream();
            pkgUpdateDao.updatePackageImageAll(id, tour_name, location_from, location_to, date,duration, price, desp1, desp2, imageUrl_1, imageUrl_2,hotel,transport);
            System.out.println("All updated");
            response.sendRedirect("manageTourPackages.jsp");
        } else {
            pkgUpdateDao.updatePackageNoImage(id, tour_name, location_from, location_to, date,duration, price, desp1, desp2,hotel,transport);
